...
class Closingranks extends StatefulWidget {
  const Closingranks({Key? key}) : super(key: key);

  @override
  _ClosingranksState createState() => _ClosingranksState();
}

enum AllCounsel { CounsellingRanking, NEETPGRank }

class _ClosingranksState extends State<Closingranks> {
